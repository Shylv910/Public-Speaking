...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM datapendaftarnajwa WHERE id=?";
    ...
    if ($result) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $update_sql = "UPDATE datapendaftarnajwa SET firstname=?, lastname=?, gender=?, email=?, nohp=? WHERE id=?";
            ...
            if ($cek > 0) {
                ...
                header("location:admin/datapendaftarNAJ.php");
            } else {
...
<form action="proses_updateN.php" method="post">
