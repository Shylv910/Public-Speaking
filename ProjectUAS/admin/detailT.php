...
$query = "INSERT INTO datapendaftartsana (firstname, lastname, gender, kelas, email, nohp, harga, bukti) VALUES ('$firstname', '$lastname', '$gender', '$kelas', '$email', '$nohp', '$harga', '$gambar_content')";
...
$query_last = "SELECT * FROM datapendaftartsana ORDER BY id DESC LIMIT 1"; // Mendapatkan data terbaru
...
if (mysqli_num_rows($result_last) > 0) {
    ...
    <body>
        ...
        <!-- Tombol Kembali -->
        <div>
            <a href="datapendaftarTSANA.php" class="btn btn-sm btn-info pull-right">Kembali</a>
        </div>
    </body>
