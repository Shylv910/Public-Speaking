...
<body>
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            <?php
            $id = $_GET['id'];
            $pendaftar = mysqli_query($koneksi, "SELECT * FROM datapendaftarnajwa WHERE id='$id'");
            while ($t = mysqli_fetch_array($pendaftar)) {
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th>:</th>
                        <td>
                            <?php echo "Rp. " . number_format($t['harga']) . " ,-"; ?>
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php
                    $id = $t['id'];
                    $kelas = mysqli_query($koneksi, "SELECT * FROM datapendaftarnajwa WHERE id='$id'");
                    while ($p = mysqli_fetch_array($kelas)) {
                        ?>
                        <tr>
                            <td>
                                <?php echo $p['firstname']; ?>
                            </td>
                            <td width="25%">
                                <?php echo $p['kelas']; ?>
                            </td>
