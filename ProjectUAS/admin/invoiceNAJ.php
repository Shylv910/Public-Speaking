...
<body>
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            <?php
            $id = $_GET['id'];
            $transaksi = mysqli_query($koneksi, "SELECT * FROM datapendaftarnajwa WHERE id='$id'");
            while($t = mysqli_fetch_array($transaksi)){
            ?>
                <center><h2>KELAS PUBLIC SPEAKING</h2></center>
                <h3></h3>
                <a href="cetakNAJ.php?id=<?php echo $id; ?>" target="_blank" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-print"></i> CETAK</a>
                <br/>
                <br/>
                <table class="table">
                    <tr>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php
                    $id = $t['id'];
                    $tsana = mysqli_query($koneksi, "SELECT * FROM datapendaftarnajwa WHERE id='$id'");
